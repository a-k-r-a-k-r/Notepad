...
root = tkinter.Tk()
root.title('Notepad')
root.iconbitmap('resources/icons/notepad.ico')
...
def open_note():
    ...
    with open(open_name, 'r') as f:
        ...
        #Call the change font for these .set() and pass an arbitrary value change_font(1)
